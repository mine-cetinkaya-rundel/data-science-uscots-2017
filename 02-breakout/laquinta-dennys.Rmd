...
hotels <- hotels %>%
  ...
  slice(1:10) # due to slow internet at the hotel
```
...
ggplot(data=world, map=world, aes(map_id=region)) +
  geom_map(, color="white", fill="grey") +
  geom_point(data=hotels, aes(x=longitude, y=latitude)) +
  theme_bw()
```

# Get Denny's locations
